...
/**
 * Hook to fetch a specific account manager by their account_manager_id from the database
 */
export function useAccountManager(accountManagerUuid: string): AccountManagerOption | null {
  const compiled = db
    ...
    .where("am.id", "=", accountManagerUuid)
  ...
  console.log("useAccountManager - fetched data:", data);
