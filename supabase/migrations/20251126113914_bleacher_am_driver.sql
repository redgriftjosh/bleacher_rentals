...
--   user_id      bigint not null,
--   constraint "UserRoleAssignments_pkey" primary key (user_role_id)
-- );

-- alter table "public"."UserRoleAssignments" enable row level security;

--   create policy "Allow All for Auth"
--   on "public"."UserRoleAssignments"
--   as permissive
--   for all
--   to authenticated
-- using (true);
